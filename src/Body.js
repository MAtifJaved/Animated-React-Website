...
import img1 from './images/bc.gif';
import img2 from './images/ai.gif';
import img3 from './images/iot.gif';
import img4 from './images/qc.gif';
import img5 from './images/cs.gif';
...
function Body(){
    return(
        ...
        <div>
         ...
         <Slide right >
         Learn the technologies that are shaping our future
        </Slide>
        </LightSpeed>
...
<div className={style.rowdiv}>
<div className={style.alternate}>
<Tilt className="Tilt" options={{ max : 25 }} style={{ height: 500, width: 500 }} >
 <div className="Tilt-inner">  <div className={style.container}>
    <div className={style.box}>
        <div className={style.imgBx}>
